// Update Facebook data with real insights (fixed version)
const path = require('path');
const Database = require('better-sqlite3');
const https = require('https');

async function updateFacebookWithRealInsightsFixed() {
  try {
    ...
    // Clear existing data in correct order (analytics first, then posts)
...
updateFacebookWithRealInsightsFixed();

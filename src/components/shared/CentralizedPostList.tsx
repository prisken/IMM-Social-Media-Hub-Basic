...
interface CentralizedPostListProps {
  viewMode: 'grid' | 'list'
  searchQuery?: string
...
export function CentralizedPostList({ 
  viewMode, 
  searchQuery = '', 
  selectedPostId, 
  onPostSelect, 
...
}: CentralizedPostListProps) {
  const { state, refreshData, deletePost: deletePostFromContext } = useData()
